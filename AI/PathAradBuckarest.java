...
public class PathAradBuckarest {
	...
	private HashMap<Integer, Node> cities = new HashMap<Integer, PathAradBuckarest.Node>(); 
	...
	private ArrayList<Node> findAdjNodes(int n){
		ArrayList<Node> adjNodes = new ArrayList<PathAradBuckarest.Node>();
	...
	private ArrayList<Edge> findAdjEdges(int n){
		ArrayList<Edge> adjEdges = new ArrayList<PathAradBuckarest.Edge>();
		for(int i = 0; i < NUM_OF_CITIES; i++){
			if(map[n][i] != null){
	...
	public static void main(String[] args) {
		PathAradBuckarest us = new PathAradBuckarest();
		
		Node src = us.arad;
		Node dest = us.bucharest;
        
        Scanner sc =new Scanner(System.in);
        int choice;

        while(true){
            System.out.println("1: Breadth First Search Program ");
            System.out.println(("2: Depth First Search Program "));
            System.out.println("3: Uniform Cost Search Program");
            ...
            switch(choice){
                case 1:
                    ...
                    System.out.println("**********Welcome in Breadth First Search Program ***************");
                ...
                case 2:
                    ...
                    System.out.println("*******Welcome in Depth First Search Program ***************");
                ...
                case 3:
                    ...
                    System.out.println("*****Welcome in Uniform Cost Search Program***************");
                    ...
                    break;
                case 4:
                    System.out.println("Goodbye!! Thanks for using our Artificial Intelligence Program");
                     System.exit(0);
                default:
